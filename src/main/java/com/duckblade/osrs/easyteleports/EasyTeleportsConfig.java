...
public interface EasyTeleportsConfig extends Config {
    ...
    // Construction cape
    @ConfigItem(
            keyName = "enableConstructionCape",
            name = "Construction cape",
            description = "Replace teleport entries on the Construction cape with new names.",
            section = SECTION_ENABLE_FLAGS,
            position = POSITION_FLAGS + (POSITION_CONSTRUCTION_CAPE / 100)
    )
    default boolean enableConstructionCape() {
        return false;
    }

    @ConfigSection(
            name = "Construction cape",
            description = "Replacement text for Construction cape teleport locations.",
            position = POSITION_CONSTRUCTION_CAPE,
            closedByDefault = true
    )
    String SECTION_CONSTRUCTION_CAPE = "sectionConstructionCape";

    @ConfigItem(
            keyName = "replacementConstructCapeHome",
            name = "Home",
            description = "Replace Home teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 1
    )
    default String replacementConstructCapeHome() {
        return "<col=8800ff>Home</col>";
    }

    @ConfigItem(
            keyName = "replacementConstructCapeRimmington",
            name = "Rimmington",
            description = "Replace Rimmington teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 2
    )
    default String replacementConstructCapeRimmington() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementConstructCapeTaverley",
            name = "Taverley",
            description = "Replace Taverley Village teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 3
    )
    default String replacementConstructCapeTaverley() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementConstructCapePollnivneach",
            name = "Pollnivneach",
            description = "Replace Pollnivneach teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 4
    )
    default String replacementConstructCapePollnivneach() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementConstructCapeHosidius",
            name = "Hosidius",
            description = "Replace Hosidius teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 5
    )
    default String replacementConstructCapeHosidius() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementConstructCapeAldarin",
            name = "Aldarin",
            description = "Replace Aldarin teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 6
    )
    default String replacementConstructCapeAldarin() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementConstructCapeRellekka",
            name = "Rellekka",
            description = "Replace Rellekka teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 7
    )
    default String replacementConstructCapeRellekka() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementConstructCapeBrimhaven",
            name = "Brimhaven",
            description = "Replace Brimhaven teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 8
    )
    default String replacementConstructCapeBrimhaven() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementConstructCapeYanille",
            name = "Yanille",
            description = "Replace Yanille teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 9
    )
    default String replacementConstructCapeYanille() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementConstructCapePrifddinas",
            name = "Prifddinas",
            description = "Replace Prifddinas teleport location name.",
            section = SECTION_CONSTRUCTION_CAPE,
            position = POSITION_CONSTRUCTION_CAPE + 10
    )
    default String replacementConstructCapePrifddinas() {
        return "";
    }

    // Fishing cape
    @ConfigItem(
            keyName = "enableFishingCape",
            name = "Fishing cape",
            description = "Replace teleport entries on the Fishing cape with new names.",
            section = SECTION_ENABLE_FLAGS,
            position = POSITION_FLAGS + (POSITION_FISHING_CAPE / 100)
    )
    default boolean enableFishingCape() {
        return false;
    }

    @ConfigSection(
            name = "Fishing cape",
            description = "Replacement text for Fishing cape teleport locations.",
            position = POSITION_FISHING_CAPE,
            closedByDefault = true
    )
    String SECTION_FISHING_CAPE = "sectionFishingCape";

    @ConfigItem(
            keyName = "replacementFishingCapeFishingGuild",
            name = "Fishing Guild",
            description = "Replace Fishing Guild teleport location name.",
            section = SECTION_FISHING_CAPE,
            position = POSITION_FISHING_CAPE + 1
    )
    default String replacementFishingCapeFishingGuild() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementFishingCapeOttosGrotto",
            name = "Otto's Grotto",
            description = "Replace Otto's Grotto teleport location name.",
            section = SECTION_FISHING_CAPE,
            position = POSITION_FISHING_CAPE + 2
    )
    default String replacementFishingCapeOttosGrotto() {
        return "Barbarian fishing";
    }

    // Hunter cape
    @ConfigItem(
            keyName = "enableHunterCape",
            name = "Hunter cape",
            description = "Replace teleport entries on the Hunter cape with new names.",
            section = SECTION_ENABLE_FLAGS,
            position = POSITION_FLAGS + (POSITION_HUNTER_CAPE / 100)
    )
    default boolean enableHunterCape() {
        return false;
    }

    @ConfigSection(
            name = "Hunter cape",
            description = "Replacement text for Hunter cape teleport locations.",
            position = POSITION_HUNTER_CAPE,
            closedByDefault = true
    )
    String SECTION_HUNTER_CAPE = "sectionHunterCape";

    @ConfigItem(
            keyName = "replacementHunterCapeHunterGuild",
            name = "Hunter Guild",
            description = "Replace Hunter Guild teleport location name.",
            section = SECTION_HUNTER_CAPE,
            position = POSITION_HUNTER_CAPE + 1
    )
    default String replacementHunterCapeHunterGuild() {
        return "";
    }

    @ConfigItem(
            keyName = "replacementHunterCapeFeldipHills",
            name = "Feldip Hills",
            description = "Replace Feldip Hills teleport location name.",
            section = SECTION_HUNTER_CAPE,
            position = POSITION_HUNTER_CAPE + 2
    )
    default String replacementHunterCapeFeldipHills() {
        return "Red chinchompas";
    }

    @ConfigItem(
            keyName = "replacementHunterCapeBlackChinchompas",
            name = "Black Chinchompas",
            description = "Replace Black Chinchompas teleport location name.",
            section = SECTION_HUNTER_CAPE,
            position = POSITION_HUNTER_CAPE + 3
    )
    default String replacementHunterCapeBlackChinchompas() {
    ...
    @ConfigSection(
            name = "Max cape",
            description = "Replacement text for Max cape teleport location names.",
